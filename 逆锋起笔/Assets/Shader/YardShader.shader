...
Shader "ChinesePainting/YardShader" 
{
	Properties 
	{
		[Header(OutLine)]
		...
		// Outside Noise Width
		_OutsideNoiseWidth ("Outside Noise Width", Range(1, 2)) = 1.1
		_MaxOutlineZOffset ("Max Outline Z Offset", Range(0,1)) = 0.6
    ...
    SubShader 
	{
		...
		Pass 
		{
			...
			v2f vert (a2v v) 
			{
				...
				float linewidth = -position_cs.z / (2*unity_CameraProjection[1].y);
